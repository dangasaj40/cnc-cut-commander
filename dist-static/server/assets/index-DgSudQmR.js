import { _ as requireReact, T as jsxRuntimeExports, r as reactExports, $ as getDefaultExportFromCjs, a0 as commonjsGlobal, a1 as React } from "./worker-entry-Be5YVpJa.js";
import { r as reactDomExports, s as supabase, u as useAuth, N as Navigate } from "./router-BQgQf1IX.js";
import { S as SectionHeader } from "./users-BPolboBD.js";
import { P as Package, W as Weight, L as Layers } from "./weight-D4n6Q6Vd.js";
...
function Metric({ label, unit: unit2, value, hint, highlight, icon }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `glass-card p-6 flex flex-col justify-between min-h-[160px] relative overflow-hidden transition-all hover:border-primary/30 group ${highlight ? "border-primary/20" : ""}`, children: [
    highlight && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 size-32 bg-primary/10 blur-[60px] -mr-16 -mt-16 rounded-full" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground", children: label }),
        hint && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-medium text-muted-foreground/60 tracking-wider uppercase", children: hint })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `size-10 rounded-xl flex items-center justify-center transition-all duration-500 ${highlight ? "bg-primary/20 text-primary shadow-[0_0_20px_rgba(251,191,36,0.15)] group-hover:shadow-[0_0_30px_rgba(251,191,36,0.3)]" : "bg-white/5 text-muted-foreground group-hover:text-white"}`, children: icon })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto z-10 flex items-baseline gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-4xl font-black tracking-tight tabular-nums ${highlight ? "text-primary" : "text-white"}`, children: value }),
      unit2 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-widest", children: unit2 })
    ] })
  ] });
}
...
function Dashboard() {
  ...
  reactExports.useEffect(() => {
    const since = period === "today" ? startOfDay(/* @__PURE__ */ new Date()) : period === "week" ? startOfWeek(/* @__PURE__ */ new Date(), { weekStartsOn: 1 }) : startOfMonth(/* @__PURE__ */ new Date());
    setLoading(true);
    supabase.from("producao").select("data,quantidade,peso_total,tempo_total_segundos,nesting").gte("data", format$1(since, "yyyy-MM-dd")).then(({ data }) => {
      setRows(data ?? []);
      setLoading(false);
    });
  }, [period]);
  const totals = reactExports.useMemo(() => {
    const pieces = rows.reduce((s2, r2) => s2 + (r2.quantidade || 0), 0);
    const kg = rows.reduce((s2, r2) => s2 + Number(r2.peso_total || 0), 0);
    const nestings = new Set(rows.map((r2) => r2.nesting).filter(Boolean)).size;
  ...
  const chartData = reactExports.useMemo(() => {
    ...
    for (let i = days - 1; i >= 0; i--) {
      const d = format$1(subDays(/* @__PURE__ */ new Date(), i), "yyyy-MM-dd");
      map2[d] = 0;
    }
    rows.forEach((r2) => {
      if (map2[r2.data] !== void 0) map2[r2.data] += Number(r2.peso_total || 0);
    });
    return Object.entries(map2).map(([d, kg]) => ({ day: format$1(/* @__PURE__ */ new Date(d + "T00:00:00"), "dd/MM"), kg: Math.round(kg) }));
  }, [rows]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
        ...
        right: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-white/5 p-1 rounded-2xl border border-white/5", children: ["today", "week", "month"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setPeriod(p),
            className: `px-4 py-2 text-[10px] font-bold uppercase tracking-widest rounded-xl transition-all ${period === p ? "bg-primary text-white shadow-lg shadow-primary/20" : "text-muted-foreground hover:text-white"}`,
            children: p === "today" ? "Hoje" : p === "week" ? "Semana" : "Mês"
          },
          p
        )) })
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Metric,
        {
          ...
          unit: "KG",
          highlight: true,
          hint: `${(totals.kg / 1e3).toFixed(2)} t`,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Weight, { size: 20 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Metric,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 glass-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "text-primary", size: 20 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-bold uppercase tracking-widest text-white", children: "Produção (KG)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-muted-foreground uppercase tracking-widest bg-white/5 px-3 py-1 rounded-full", children: "T-7D → Hoje" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chartData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "barGradient", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "var(--laser)", stopOpacity: 1 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "var(--laser)", stopOpacity: 0.3 })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "rgba(255,255,255,0.05)", strokeDasharray: "3 3", vertical: false }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            XAxis,
            {
              dataKey: "day",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "kg", fill: "url(#barGradient)", radius: [6, 6, 0, 0] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "text-primary", size: 20 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-bold uppercase tracking-widest text-white", children: "Eficiência" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { size: 16 }), label: "Total (Toneladas)", value: `${(totals.kg / 1e3).toFixed(2)} t` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 16 }), label: "Peças Processadas", value: `${totals.pieces} pcs` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 16 }), label: "Nestings Únicos", value: totals.nestings.toString() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 16 }), label: "Lançamentos", value: rows.length.toString() })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 pt-6 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 border border-primary/20 p-4 rounded-2xl flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-2 bg-primary rounded-full shadow-[0_0_8px_var(--laser)] animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest text-primary", children: "Sistema Sincronizado" })
        ] }) })
      ] })
    ] })
  ] });
...
function SummaryItem({ icon, label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 bg-white/5 rounded-lg flex items-center justify-center text-muted-foreground group-hover:text-primary transition-colors", children: icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground uppercase tracking-widest font-medium", children: label })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold tabular-nums text-white", children: value })
  ] });
}
function IndexPage() {
  const {
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(BootSplash, {});
...
function BootSplash() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-dvh flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.3em] text-laser uppercase animate-pulse", children: "// INITIALIZING" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-xs text-muted-foreground tracking-widest", children: "PLASMA CONTROL" })
  ] }) });
}
export {
